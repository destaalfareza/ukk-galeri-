...
body {
            margin: 0;
            padding: 0;
            background-image: url('./gambar/hu.jpg'); /* Ganti 'background-image.jpg' dengan lokasi dan nama file gambar latar belakang Anda */
...
form {
    background: rgba(255, 255, 255, 0.5); /* Warna putih dengan tingkat transparansi 50% */
    padding: 20px;
    border-radius: 8px;
